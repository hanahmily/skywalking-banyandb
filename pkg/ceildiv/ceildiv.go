...
// Package ceildiv computes ceiling (round-up) integer division, the
// small piece of arithmetic a caller needs to plan fixed-size batches
// or pages over a count that does not divide evenly.
package ceildiv
